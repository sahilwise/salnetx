...
const Footer = ()=>{
    return(
      ...
      <div className="backdrop-blur-3xl text-sm border bg-black/5 rounded-2xl text-neutral-500 p-6 fixed sm:bottom-4 bottom-0 left-1/2 transform -translate-x-1/2 w-96">
        {/* Your fixed div at the bottom */}
        <div className="flex grid grid-cols-3">
          
          <div className="mx-5 pt-0.5">
          <span>
          <DarkModeToggle />
          </span>
          </div>
          ...
          <a className="px-3.5 pt-0.5"  target="_blank" href="https://github.com/salnetx">
          ...
          <a className="px-3.5" target="_blank" href="https://www.producthunt.com/@salnetx">
